...
t  voltsVal = (3.3*numVal)/15;
t  tableSize = (numVal*100/15);
...
t  This results in smooth flicker-free screen update.
t  Turn potentiometer on an evaluation board clockwise or counterclockwise
t  and observe the change of AD value on the screen.<br><br>
t  <b>NOTA: Se ha dehabilitado esta funcion dado que produce interferencias con
t  la medida de la temperatura, esto se corregirá para la versión final.</b>
t </font></p>
...
t Periodic:<input style="display: none" type="checkbox" id="adChkBox" onclick="periodicUpdateAd()">
t </p></form>
i pg_footer.inc
